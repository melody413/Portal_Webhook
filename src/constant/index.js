...
const doNotSendPhotographers = {
    ...
    "Catalina Araya": ["Belinda Beekman", "Naveep Singh"],
    "April O'Neil": ["Sharon DesPasquale", "JMO", "JMO PROPERTY GROUP", "JMO Property Group Group", "Taleesha", "Taleesha Kelly", "Jennifer Oliver", "Jo Dryden", "Michelle Osmond", "Gus Yoshida", "Kristy Milford", "Lizzie Basford", "Naveep Singh", "Belinda Beekman"],
    "Andreja Mijatovic": ["JMO", "JMO PROPERTY GROUP", "JMO Property Group Group", "Taleesha", "Taleesha Kelly", "Jennifer Oliver", "Jo Dryden", "Michelle Osmond", "Belinda Beekman"],
    "Darren Hatton": ["JMO", "JMO PROPERTY GROUP", "JMO Property Group Group", "Taleesha", "Taleesha Kelly", "Jennifer Oliver", "Jo Dryden", "Michelle Osmond"],
    "Jake Heidrich": ["Belinda Beekman"],
    "Dylan Parker": [],
    "Charlie Pearce": [],
    "Eva Varga": []
};
...
const allowedPhotographers = [
    ...
    'darren.thepicketfence@gmail.com',
    'zac.thepicketfence@gmail.com'
];
